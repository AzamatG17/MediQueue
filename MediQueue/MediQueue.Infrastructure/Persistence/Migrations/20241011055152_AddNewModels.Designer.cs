...
namespace MediQueue.Infrastructure.persistence.Migrations
{
    ...
    [Migration("20241011055152_AddNewModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConclusionLekarstvo", b =>
                {
                    b.Property<int>("ConclusionsId")
                        .HasColumnType("int");

                    b.Property<int>("LekarstvaUsedByDoctorId")
                        .HasColumnType("int");

                    b.HasKey("ConclusionsId", "LekarstvaUsedByDoctorId");

                    b.HasIndex("LekarstvaUsedByDoctorId");

                    b.ToTable("ConclusionLekarstva", (string)null);
                });
            ...
            modelBuilder.Entity("ConclusionLekarstvo", b =>
                {
                    b.HasOne("MediQueue.Domain.Entities.Conclusion", null)
                        .WithMany()
                        .HasForeignKey("ConclusionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MediQueue.Domain.Entities.Lekarstvo", null)
                        .WithMany()
                        .HasForeignKey("LekarstvaUsedByDoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MediQueue.Domain.Entities.QuestionnaireHistory", b =>
                {
                    ...
                    b.Navigation("PaymentLekarstvos");
